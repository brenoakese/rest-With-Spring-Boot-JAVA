package com.brenoakese.rest_with_spring_curso.unitTest;
...
import com.brenoakese.rest_with_spring_curso.unitTest.mapper.mocks.MockPerson;
...
public class ObjectMapperTests {
    ...
    public void parseEntityListToDTOListTest() {
        List<PersonDTO> outputList = parseObjectList(inputObject.mockEntityList(), PersonDTO.class);
    ...
    public void parserDTOListToEntityListTest() {
        List<Person> outputList = parseObjectList(inputObject.mockDTOList(), Person.class);
